                ...
                <tbody>
                  {cartitems.map((items, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        <div className="d-flex ">
                          ...
                          <div>
                            ...
                            <p>
                              ₹{items.productPrice} x {items.quantity} = ₹
                      ...
                      <td className="text-center align-middle">
                        <div className="d-flex">
                          <Button
                            disabled={items.quantity < 2 ? true : false}
                            variant="danger"
                          ...
                          />
                          <Button
                            disabled={items.quantity >= 20 ? true : false}
                            variant="success"
                            onClick={() => handleIncerment(items)}
                          >
                            +
                          </Button>
                        </div>
                  ...
                  <tr>
                    <td colSpan={4} className="text-end">
                      <h5>Total = {findTotal().toFixed(1)} </h5>
                    </td>
                  </tr>
                </tbody>
              </Table>
